			...
			<div>
				<div class="mt-20">
					<div class="mt-6 sm:max-w-xl">
						...
						<p class="mt-6 text-xl text-gray-500">
							The client application reads the flags config from LaunchDarkly. A different image is
							loaded based on the evaluation of the `isWinter` boolean flag
						</p>
						<p class="mt-6 italic text-gray-500">
							Elapsed Time: {data.request_duration} performance units (3 digits of precision)
						</p>
					</div>
				</div>
			</div>
